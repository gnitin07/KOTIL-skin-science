...
// Reviews, the Google rating and the before/after pairs live in proof.js — they
// are the only content /consult also needs, and keeping them there stops that
// page's bundle from swallowing this whole file. Re-exported so every existing
// `import { REVIEWS } from './data.js'` keeps working.
export { REVIEWS, REVIEW_RATING, COMPARISONS } from './proof.js'
...
// REVIEWS and REVIEW_RATING now live in proof.js — see the re-export at the top.
...
// COMPARISONS (the before/after pairs beside the booking CTA) now lives in
// proof.js — see the re-export at the top.
